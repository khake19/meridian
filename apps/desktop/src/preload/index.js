...
contextBridge.exposeInMainWorld('meridian', {
  ...
  updateTranscriptSegmentTime: (projectId, segmentId, startMs, endMs) => ipcRenderer.invoke(
    'transcript:update-time', projectId, segmentId, startMs, endMs,
  ),
  ...
  setTranscriptSegmentTag: (projectId, segmentId, tagCode, assigned) => ipcRenderer.invoke(
    'transcript:set-tag', projectId, segmentId, tagCode, assigned,
  ),
